			...
			<c:forEach items="${studentList}" var="student">
				<tr>
					...
					<td>
						...
						<fmt:parseDate value="${student.createdAt}" pattern="yyyy-MM-dd'T'HH:mm" var="createdAt"/>
						<fmt:formatDate value="${createdAt}" pattern="yy-MM-dd HH:mm"/>
					</td>
					<td>
						<fmt:parseDate value="${student.updatedAt}" pattern="yyyy-MM-dd'T'HH:mm" var="updatedAt"/>
